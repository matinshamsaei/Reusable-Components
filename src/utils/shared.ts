export function mobileNormalizer(mobile: string) {
  ...
  else if (mobile.startsWith('+98')) return `0${mobile.substring(3)}`
  else if (mobile.startsWith('0098')) return `0${mobile.substring(4)}`
...
export function mobileDeNormalizer(mobile: string) {
  ...
  else if (mobile.startsWith('0098')) return `+${mobile.substring(2)}`
